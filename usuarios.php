...
<body class="bg-indigo-50 flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-slate-200 flex flex-col justify-between shrink-0">
        <div>
            <a href="index.html" class="h-16 flex items-center px-6 border-b border-slate-100 hover:bg-slate-50 transition">
            ...
            <nav class="mt-6 px-4 space-y-1">
                <a href="dashboard.php" class="flex items-center px-4 py-2.5 text-sm text-slate-500 rounded-lg hover:bg-slate-50 hover:text-slate-900">
                    Dashboard
                </a>
