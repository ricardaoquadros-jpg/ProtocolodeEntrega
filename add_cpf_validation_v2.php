<?php
// Script para adicionar validação de CPF no index.html (Versão Corrigida)
...
// Inserir as funções antes do fechamento do último script
// Vamos procurar a última ocorrência de </script>
$pos = strrpos($content, '</script>');
if ($pos !== false) {
    $content = substr_replace($content, $cpfValidationCode . "\n    </script>", $pos, 9);
}
...
echo "Validação de CPF adicionada ao index.html corretamente!\n";
?>
